// <summary>Implements a wrapper for the gMobiLabXferHelpers C API.</summary>
// -----------------------------------------------------------------------
...
namespace OperationPhrike.GMobiLab
{
    ...
    internal static class GMobiLabXferThreadApi
    {
        ...
        public static extern bool GetData(IntPtr xfer, ref uint count, IntPtr data);
        ...
        /// </param>
        /// <returns>
        /// How many shorts have been collected so far.
        /// </returns>
        ...
        {
            /// <summary>
            /// Initializes a new instance of the <see cref="XferThread"/> class. 
            ...
            public XferThread(GMobiLabApi.Device device)
            {
                ...
                {
                    throw new GMobiLabXferException("Failed creating Xfer thread.");
                }
            }

            /// <summary>
            /// Finalizes an instance of the <see cref="XferThread"/> class. 
